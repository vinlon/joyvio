...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="main">
        ...
        <div class="pagenavi">
            ...
            <p class="fl">
                > <a href="/News/Index.aspx?navid=<%=nav.ParentId %>">新闻中心</a> > <span>媒体报道</span></p>
            <p class="clear">
            </p>
        </div>
        <p class="clear">
        ...
        <div class="rdetail_left" id="left">
            <p>
                <img src="/!images/report_banner.jpg" alt="媒体报道" /></p>
            <%--<p class="list_title">
                媒体报道</p>--%>
            <div class="list">
                <ul>
                            ...
                            <li>
                                <p class="replist_title">
                                    <a href="/News/ReportDetail.aspx?infoid=<%#(Container.DataItem as Information).InfoId %>&navid=<%#nav.NavId.ToString() %>"
                                        ...
                                        <%#(Container.DataItem as Information).Title.SubStr(40,"...")%></a></p>
                                <p class="replist_sort">
